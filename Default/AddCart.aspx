<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Default.master" AutoEventWireup="true" CodeFile="AddCart.aspx.cs" Inherits="Default_AddCart" %>
            ...
            <div class="col-md-7 col-lg-9 col-xl-9">
              <div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                  <div><br />
                    <a href="DeleteCart.aspx?Mid=<%#Eval("Mid") %>" type="button" class="btn btn-danger mr-3">Remove</a>
                  </div>
                </div>
              </div>
            </div>
