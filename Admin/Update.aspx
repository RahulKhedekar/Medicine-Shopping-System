<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Admin.master" AutoEventWireup="true" CodeFile="Update.aspx.cs" Inherits="Admin_Update" %>
...
<div class="container">
        <div class="form-vertical">
            ...
            <div class="form-group">                
                    <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="btn btn-primary" ValidationGroup="add" OnClick="updatep"/>          
            </div>          
        </div>
    </div>
</asp:Content>
