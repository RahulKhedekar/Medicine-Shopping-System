<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Home.master" AutoEventWireup="true" CodeFile="ViewDetails.aspx.cs" Inherits="Home_ViewDetails" %>
...
<asp:Repeater ID="RepeatBooks" runat="server">
 ...
 <div class="container">
  <div class="row">
    ...
    <div class="col-md-6">
      <div class="row">
        <h2 class="bookNameView" style="margin-top:20px;"><%#Eval("MImage") %></h2>
      </div>
